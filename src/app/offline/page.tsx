...
export default function OfflinePage() {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-3 px-6 text-center">
      ...
      <p
        className="enter font-display text-lg font-semibold text-ink"
      ...
      >
        Naze butuh koneksi internet untuk berpikir dan menjawab. Chat, memori, gambar,
        dan suara semuanya perlu tersambung ke server. Sambungkan lagi ke internet, lalu
